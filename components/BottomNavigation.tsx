  ...
  return (
    <>
      ...
      <div className="hidden md:block max-w-[88%] overflow-auto no-scrollbar fixed bottom-4 left-1/2 transform -translate-x-1/2 z-50">
        <div className="game-crystal-bar bg-background  border-none">
          <div className="flex items-center gap-2 rounded-full">
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "game-nav-button relative text-center flex items-center gap-3 px-5 py-3 rounded-xl transition-all duration-300 ease-out font-ui text-foreground",
                    isActive
            ...
            <div className="w-px h-6 mx-2 bg-gradient-to-b from-transparent via-primary/50 to-transparent game-separator"></div>
